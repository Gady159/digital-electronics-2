...
/** @brief Set overflow 262ms, prescaler 011 --> 64 */
#define TIM0_OVF_1024US TCCR0B &= ~(1<<CS12); TCCR0B |= (1<<CS11) | (1<<CS10);
/** @brief Set overflow 1s, prescaler 100 --> 256 */
#define TIM0_OVF_4096US  TCCR0B &= ~((1<<CS11) | (1<<CS10)); TCCR0B |= (1<<CS12);
/** @brief Set overflow 4s, prescaler // 101 --> 1024 */
#define TIM0_OVF_16384US  TCCR0B &= ~(1<<CS11); TCCR0B |= (1<<CS12) | (1<<CS10);
